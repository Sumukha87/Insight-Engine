...
description: Check the status of all 6 pipeline stages — DVC, Neo4j graph, Qdrant embeddings, and Airflow
---
...
## Stage 4 — Graph (Neo4j)
- Run this Cypher query via Python to get graph stats:
```python
